...
mkdir -p finance-wallet-onboarding/codex/templates
mkdir -p finance-wallet-onboarding/services/src/config
...
cat <<EOF > finance-wallet-onboarding/codex/templates/provisioning.yaml
...
cat <<EOF > finance-wallet-onboarding/services/src/config/tabs.config.ts
export const tabs = [
  "DashboardTab",
  "PaymentsTab"
];
